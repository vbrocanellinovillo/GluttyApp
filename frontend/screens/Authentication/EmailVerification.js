...
export function EmailVerification() {
    ...
    const verifyCodeIngresado = () => {
      ...
      Alert.alert("Verificación correcta", "Has ingresado correctamente el código de verificación.");
    ...
    return (
        <View style={styles.container}>
            <TextCommonsMedium style={styles.title}>Verificación de Email</TextCommonsMedium>
            ...
            <TouchableOpacity onPress={resendCode}>
                <Text style={styles.resendText}>¿No recibiste el código o expiró? <Text style={styles.resendLink}>Reenviar</Text></Text>
            </TouchableOpacity>

            {/* Botón de Verificar */}
            <TouchableOpacity style={styles.verifyButton} onPress={verifyCodeIngresado}>
                <TextCommonsRegular style={styles.verifyButtonText}>Verificar cuenta</TextCommonsRegular>
            </TouchableOpacity>
        </View>
    );
}
