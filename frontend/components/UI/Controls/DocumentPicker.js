      ...
      {selectedDocuments.length > 0 && selectedDocuments.map((document, index) => (
        <View key={index} style={styles.previewContainer}>
          <View style={styles.row}>
            ...
            <TouchableOpacity>
              <Entypo name="eye" size={24} color="black" marginLeft={10}/>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => removeDocument(document.uri, document)}>
...
// ACA YA TIENE SEPARADO EL ICONO DEL OJOOOO 
...
const styles = StyleSheet.create({
  ...
  iconWrapper: {
    marginLeft: 15, // Se aumenta el margen para mejor separación entre íconos
  },
}); */
